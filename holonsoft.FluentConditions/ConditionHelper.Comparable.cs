...
public static partial class ConditionHelper
{
    ...
    string exceptionMessage = null) where T : IComparable<T>
  {
    ...
    throw new ArgumentOutOfRangeException(
        ...
        valueHolder.GetExceptionCallerText(exceptionMessage ?? $"'{valueHolder.ValueName}' with value '{value}' is not in the range of '{minValue}' to '{maxValue}'!"));
  }
    ...
    string exceptionMessage = null) where T : IComparable<T>
  {
    ...
    throw new ArgumentOutOfRangeException(
        valueHolder.ValueName,
        valueHolder.GetExceptionCallerText(exceptionMessage ?? $"'{valueHolder.ValueName}' with value '{value}' is in the range of '{minValue}' to '{maxValue}'!"));
  }
    ...
    string exceptionMessage = null) where T : IComparable<T>
  {
    ...
    throw new ArgumentOutOfRangeException(
        valueHolder.ValueName,
        valueHolder.GetExceptionCallerText(exceptionMessage ?? $"'{valueHolder.ValueName}' with value '{value}' is smaller than '{minValue}'!"));
  }
    ...
    string exceptionMessage = null) where T : IComparable<T>
  {
    ...
    throw new ArgumentOutOfRangeException(
        valueHolder.ValueName,
        valueHolder.GetExceptionCallerText(exceptionMessage ?? $"'{valueHolder.ValueName}' with value '{value}' is bigger than '{maxValue}'!"));
  }
